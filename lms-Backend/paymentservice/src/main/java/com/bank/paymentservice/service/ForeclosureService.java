...
public class ForeclosureService {
    ...
    public ForeclosureService(
            ForeclosureRequestRepository repo,
    ...
    public String requestForeclosure(Long loanId) {
        ...
        // 2️⃣ FIRST update LOAN‑SERVICE (SOURCE OF TRUTH)
        loanClient.requestForeclosure(loanId);

        // 3️⃣ THEN save request in PAYMENT DB
    ...
    public Double approveByLoanId(Long loanId) {
        ...
        // 3️⃣ Approve request in PAYMENT DB
    ...
    public String payForeclosure(Long requestId) {
        ...
        // 2️⃣ Mark payment completed in PAYMENT DB
        req.setStatus("PAID");
